...
Next, several pods showed errors related to Persistent Volume Claims (PVCs). Using kubectl describe pvc <pvc-name>, we identified the following error:
...
<CodeBlock
    ...
    codeInstances={[
        {
            code: `kubectl describe service <service-name> -n production`,
            label: "Git Configuration",
            language: "bash",
        },
    ]}
